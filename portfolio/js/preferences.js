...
const COPY = {
	en: {
		...
		'service.fullCycle': 'Strategy → craft → launch', 'service.skills': 'Core skills', 'service.outputs': 'What you receive', 'service.pipeline': 'Delivery pipeline',
		'service.discover': 'Discover', 'service.design': 'Create', 'service.deliver': 'Deliver', 'service.explore': 'Explore service',
		...
		'process.eyebrow': '<span>04</span> Workflow', 'process.title': 'From idea to <em>delivery.</em>', 'process.description': 'A visible, collaborative process with a clear purpose and output at every stage.',
		'process.1.title': 'Discovery & scope', 'process.1.text': 'We clarify the audience, goals, references, required features and the exact definition of done.',
		'process.2.title': 'Direction & structure', 'process.2.text': 'I shape the information architecture, user journey, content priorities and visual direction before production.',
		'process.3.title': 'UI design & prototype', 'process.3.text': 'Key screens and responsive states become a coherent interface with clear feedback checkpoints.',
		'process.4.title': 'Build & motion', 'process.4.text': 'The approved direction is developed with responsive code, purposeful animation and manageable content systems.',
		'process.5.title': 'QA & optimization', 'process.5.text': 'I test real screen sizes, interactions, accessibility, loading behavior and edge cases before launch.',
		'process.6.title': 'Launch & handover', 'process.6.text': 'Deployment, domain connection, source files and practical guidance are prepared for a confident handover.',
		'process.assurance.1': 'Clear milestones and progress tracking', 'process.assurance.2': 'Review points before major build decisions', 'process.assurance.3': 'Source files, deployment and handover guidance',
		...
		'booking.successText': 'Your project brief has been securely saved. You can track it in the Admin Dashboard.', 'booking.home': 'Back home <span aria-hidden="true">↗</span>',
		'booking.portalReady': 'Your private client portal is ready', 'booking.portalKeepLink': 'Keep this link to follow the project and review deliveries.', 'booking.openPortal': 'Open project portal',
		...
		'admin.noServiceImage': 'No custom image', 'admin.threeFallback': 'The current Three.js visual will be used.', 'admin.uploadImage': 'Upload image', 'admin.replaceImage': 'Replace image', 'admin.removeImage': 'Remove image',
		'admin.imageHint': 'JPG, PNG or WebP · up to 12 MB. Images are optimized automatically before saving.', 'admin.processingImage': 'Optimizing image…', 'admin.imageSaved': 'Service image saved and published.', 'admin.imageRemoved': 'Custom image removed. Three.js visual restored.',
		'admin.imageTypeError': 'Please choose a JPG, PNG or WebP image.', 'admin.imageSizeError': 'The source image must be smaller than 12 MB.', 'admin.imageCompressError': 'This image could not be optimized enough. Choose a smaller image.', 'admin.imageSaveError': 'Unable to save this image.',
		...
		'admin.clientUpdate': 'New progress report for client', 'admin.clientUpdatePlaceholder': 'Briefly explain what was completed, what is happening now and what comes next…', 'admin.clientUpdateHint': 'Leave blank if you only want to update internal data. A written report is saved to the client timeline.', 'admin.copyPortal': 'Copy client portal', 'admin.portalCopied': 'Private client portal link copied.', 'admin.copyPortalPrompt': 'Copy this private client portal link:',
		'admin.clientResponded': 'sent a portal review.', 'admin.clientResponseTitle': 'Client portal response', 'admin.clientResponseAt': 'Received', 'admin.noClientComment': 'Approved without an additional comment.',
		'admin.notifications': 'Notifications', 'admin.notificationTitle': 'New project requests', 'admin.markRead': 'Mark all read', 'admin.enableAlerts': 'Enable background alerts', 'admin.installApp': 'Install Admin app',
		...
		'admin.alertsUnsupported': 'Browser notifications are not supported.', 'admin.alertsEnabled': 'Browser alerts enabled.', 'admin.alertsBlocked': 'Notification permission was not granted.', 'admin.pushUnsupported': 'This browser cannot receive background notifications.', 'admin.pushEnabled': 'Background order notifications are now active on this device.', 'admin.pushError': 'Unable to activate push notifications. Install the Admin app and try again.',
		...
		'client.live': 'Live project workspace', 'client.loading': 'Loading your project…', 'client.backSite': 'Back to website ↗', 'client.notSet': 'Not set', 'client.project': 'Project', 'client.invalidTitle': 'This project link is unavailable.', 'client.invalidText': 'The link may be incomplete, expired or not associated with a project. Ask Pozan Market for a new private link.',
		'client.status.new': 'Request received', 'client.status.contacted': 'Contacted', 'client.status.in-progress': 'In progress', 'client.status.completed': 'Completed', 'client.status.archived': 'Archived',
		'client.phase.discovery': 'Discovery', 'client.phase.planning': 'Planning', 'client.phase.design': 'Design', 'client.phase.development': 'Development', 'client.phase.review': 'Client review', 'client.phase.delivery': 'Delivery',
		'client.complete': 'complete', 'client.hello': 'Hi', 'client.heroText': 'This private workspace keeps your progress, review points and delivery links in one place.', 'client.phase': 'Current phase', 'client.phaseHint': 'Where the project is now', 'client.delivery': 'Target delivery', 'client.deliveryHint': 'Current planned date', 'client.nextAction': 'Next action', 'client.waitingUpdate': 'Waiting for the next update', 'client.noDate': 'No follow-up date', 'client.approval': 'Your approval', 'client.updated': 'Updated', 'client.approvalHint': 'Review status',
		'client.approval.not-sent': 'Nothing to review yet', 'client.approval.pending': 'Waiting for your review', 'client.approval.changes': 'Changes requested', 'client.approval.approved': 'Approved', 'client.updateFromStudio': 'Latest studio update',
		'client.milestones': 'Project milestones', 'client.milestonesText': 'The main checkpoints from kickoff to delivery.', 'client.noMilestones': 'Milestones will appear when the project plan is ready.', 'client.noDeadline': 'No deadline yet', 'client.milestone.planned': 'Planned', 'client.milestone.working': 'In progress', 'client.milestone.review': 'In review', 'client.milestone.done': 'Done',
		'client.payment': 'Payment summary', 'client.totalBudget': 'Agreed total', 'client.paid': 'Paid', 'client.remaining': 'Remaining', 'client.paymentComplete': 'of payment completed', 'client.paymentPending': 'Payment details will appear after the scope and budget are confirmed.',
		'client.files': 'Project links', 'client.filesText': 'Review files, prototypes and delivery resources.', 'client.noFiles': 'No project links have been shared yet.', 'client.review': 'Review & feedback', 'client.reviewText': 'Approve the current direction or describe the changes you need.', 'client.feedback': 'Your feedback', 'client.feedbackPlaceholder': 'Add clear feedback or revision notes…', 'client.requestChanges': 'Request changes', 'client.approve': 'Approve direction', 'client.feedbackRequired': 'Please describe the changes you need.', 'client.approvedToast': 'Thank you. Your approval was sent.', 'client.changesToast': 'Your revision request was sent.', 'client.responseError': 'Unable to send your response. Please try again.',
		'client.latestReport': 'Latest progress report', 'client.noReportsTitle': 'Your first update is being prepared.', 'client.noReportsText': 'A clear progress note from the studio will appear here.', 'client.reportTitle': 'Update from Pozan Market', 'client.olderReports': 'View previous reports', 'client.tracking': 'Project tracking', 'client.simpleFeedbackTitle': 'One clear place to respond.'
	},
	vi: {
		...
		'service.fullCycle': 'Chiến lược → thực thi → ra mắt', 'service.skills': 'Kỹ năng cốt lõi', 'service.outputs': 'Sản phẩm nhận được', 'service.pipeline': 'Quy trình triển khai',
		'service.discover': 'Khám phá', 'service.design': 'Sáng tạo', 'service.deliver': 'Bàn giao', 'service.explore': 'Xem dịch vụ',
		...
		'process.eyebrow': '<span>04</span> Quy trình', 'process.title': 'Từ ý tưởng đến <em>bàn giao.</em>', 'process.description': 'Quy trình minh bạch, phối hợp chặt chẽ với mục tiêu và đầu ra rõ ràng ở từng giai đoạn.',
		'process.1.title': 'Khám phá & xác định phạm vi', 'process.1.text': 'Cùng làm rõ đối tượng, mục tiêu, hình ảnh tham khảo, tính năng và tiêu chí hoàn thành cụ thể.',
		'process.2.title': 'Định hướng & cấu trúc', 'process.2.text': 'Xây dựng kiến trúc thông tin, hành trình người dùng, ưu tiên nội dung và hướng hình ảnh trước khi sản xuất.',
		'process.3.title': 'Thiết kế UI & prototype', 'process.3.text': 'Các màn hình chính và trạng thái responsive được phát triển thành giao diện nhất quán với từng điểm duyệt rõ ràng.',
		'process.4.title': 'Lập trình & chuyển động', 'process.4.text': 'Hướng đã duyệt được phát triển bằng code responsive, animation có mục đích và hệ thống nội dung dễ quản lý.',
		'process.5.title': 'Kiểm thử & tối ưu', 'process.5.text': 'Kiểm tra kích thước màn hình thực tế, tương tác, khả năng tiếp cận, tốc độ tải và các trường hợp ngoại lệ.',
		'process.6.title': 'Ra mắt & bàn giao', 'process.6.text': 'Chuẩn bị triển khai, kết nối tên miền, file nguồn và hướng dẫn cần thiết để bàn giao tự tin.',
		'process.assurance.1': 'Mốc tiến độ và theo dõi rõ ràng', 'process.assurance.2': 'Duyệt trước các quyết định triển khai lớn', 'process.assurance.3': 'File nguồn, triển khai và hướng dẫn bàn giao',
		...
		'booking.successText': 'Yêu cầu của bạn đã được lưu an toàn và có thể theo dõi trong trang quản trị.', 'booking.home': 'Về trang chủ <span aria-hidden="true">↗</span>',
		'booking.portalReady': 'Khu vực theo dõi riêng đã sẵn sàng', 'booking.portalKeepLink': 'Hãy lưu link này để theo dõi và duyệt các nội dung bàn giao.', 'booking.openPortal': 'Mở trang dự án',
		...
		'admin.noServiceImage': 'Chưa có ảnh riêng', 'admin.threeFallback': 'Website đang sử dụng hình Three.js mặc định.', 'admin.uploadImage': 'Tải ảnh lên', 'admin.replaceImage': 'Thay ảnh', 'admin.removeImage': 'Xoá ảnh',
		'admin.imageHint': 'JPG, PNG hoặc WebP · tối đa 12 MB. Ảnh sẽ được tự động tối ưu trước khi lưu.', 'admin.processingImage': 'Đang tối ưu ảnh…', 'admin.imageSaved': 'Đã lưu và cập nhật ảnh dịch vụ.', 'admin.imageRemoved': 'Đã xoá ảnh riêng và khôi phục hình Three.js.',
		'admin.imageTypeError': 'Hãy chọn ảnh JPG, PNG hoặc WebP.', 'admin.imageSizeError': 'Ảnh gốc phải nhỏ hơn 12 MB.', 'admin.imageCompressError': 'Không thể tối ưu đủ dung lượng. Hãy chọn ảnh nhỏ hơn.', 'admin.imageSaveError': 'Không thể lưu ảnh này.',
		...
		'admin.clientUpdate': 'Báo cáo tiến độ mới cho khách', 'admin.clientUpdatePlaceholder': 'Tóm tắt việc đã xong, việc đang làm và bước tiếp theo…', 'admin.clientUpdateHint': 'Để trống nếu chỉ cập nhật dữ liệu nội bộ. Báo cáo có nội dung sẽ được lưu vào timeline của khách.', 'admin.copyPortal': 'Sao chép portal khách', 'admin.portalCopied': 'Đã sao chép link Client Portal riêng tư.', 'admin.copyPortalPrompt': 'Sao chép link Client Portal riêng tư này:',
		'admin.clientResponded': 'vừa gửi phản hồi từ Client Portal.', 'admin.clientResponseTitle': 'Phản hồi từ Client Portal', 'admin.clientResponseAt': 'Nhận lúc', 'admin.noClientComment': 'Khách đã duyệt và không để lại ghi chú.',
		'admin.notifications': 'Thông báo', 'admin.notificationTitle': 'Yêu cầu dự án mới', 'admin.markRead': 'Đánh dấu đã đọc', 'admin.enableAlerts': 'Bật thông báo khi đóng app', 'admin.installApp': 'Cài ứng dụng Admin',
		...
		'admin.alertsUnsupported': 'Trình duyệt không hỗ trợ thông báo.', 'admin.alertsEnabled': 'Đã bật thông báo trình duyệt.', 'admin.alertsBlocked': 'Bạn chưa cấp quyền gửi thông báo.', 'admin.pushUnsupported': 'Trình duyệt này không hỗ trợ nhận thông báo nền.', 'admin.pushEnabled': 'Thiết bị này sẽ báo ngay khi có order mới, kể cả khi đã đóng Admin.', 'admin.pushError': 'Chưa thể bật push notification. Hãy cài Admin vào màn hình chính rồi thử lại.',
		...
		'client.live': 'Dữ liệu dự án trực tiếp', 'client.loading': 'Đang tải dự án của bạn…', 'client.backSite': 'Quay lại website ↗', 'client.notSet': 'Chưa xác định', 'client.project': 'Dự án', 'client.invalidTitle': 'Link dự án này không khả dụng.', 'client.invalidText': 'Link có thể bị thiếu, không còn đúng hoặc chưa gắn với dự án. Hãy liên hệ Pozan Market để nhận link riêng mới.',
		'client.status.new': 'Đã tiếp nhận yêu cầu', 'client.status.contacted': 'Đã liên hệ', 'client.status.in-progress': 'Đang thực hiện', 'client.status.completed': 'Đã hoàn thành', 'client.status.archived': 'Đã lưu trữ',
		'client.phase.discovery': 'Tiếp nhận', 'client.phase.planning': 'Lập kế hoạch', 'client.phase.design': 'Thiết kế', 'client.phase.development': 'Lập trình', 'client.phase.review': 'Khách hàng duyệt', 'client.phase.delivery': 'Bàn giao',
		'client.complete': 'hoàn thành', 'client.hello': 'Xin chào', 'client.heroText': 'Không gian riêng này tập hợp tiến độ, các mốc duyệt và link bàn giao của dự án.', 'client.phase': 'Giai đoạn hiện tại', 'client.phaseHint': 'Dự án đang ở đâu', 'client.delivery': 'Dự kiến bàn giao', 'client.deliveryHint': 'Ngày dự kiến hiện tại', 'client.nextAction': 'Bước tiếp theo', 'client.waitingUpdate': 'Đang chờ cập nhật tiếp theo', 'client.noDate': 'Chưa có ngày xử lý', 'client.approval': 'Trạng thái duyệt', 'client.updated': 'Cập nhật', 'client.approvalHint': 'Tình trạng duyệt',
		'client.approval.not-sent': 'Chưa có nội dung cần duyệt', 'client.approval.pending': 'Đang chờ bạn duyệt', 'client.approval.changes': 'Đã yêu cầu chỉnh sửa', 'client.approval.approved': 'Đã duyệt', 'client.updateFromStudio': 'Cập nhật mới nhất từ studio',
		'client.milestones': 'Các mốc dự án', 'client.milestonesText': 'Những điểm kiểm tra chính từ bắt đầu đến bàn giao.', 'client.noMilestones': 'Các mốc sẽ xuất hiện khi kế hoạch dự án sẵn sàng.', 'client.noDeadline': 'Chưa có deadline', 'client.milestone.planned': 'Dự kiến', 'client.milestone.working': 'Đang làm', 'client.milestone.review': 'Đang duyệt', 'client.milestone.done': 'Hoàn tất',
		'client.payment': 'Tình trạng thanh toán', 'client.totalBudget': 'Tổng đã chốt', 'client.paid': 'Đã thanh toán', 'client.remaining': 'Còn lại', 'client.paymentComplete': 'thanh toán hoàn tất', 'client.paymentPending': 'Chi tiết thanh toán sẽ xuất hiện sau khi chốt phạm vi và ngân sách.',
		'client.files': 'Link dự án', 'client.filesText': 'File duyệt, prototype và tài nguyên bàn giao.', 'client.noFiles': 'Chưa có link dự án nào được chia sẻ.', 'client.review': 'Duyệt & phản hồi', 'client.reviewText': 'Duyệt hướng hiện tại hoặc mô tả nội dung cần chỉnh sửa.', 'client.feedback': 'Phản hồi của bạn', 'client.feedbackPlaceholder': 'Nhập phản hồi hoặc yêu cầu chỉnh sửa rõ ràng…', 'client.requestChanges': 'Yêu cầu chỉnh sửa', 'client.approve': 'Duyệt phương án', 'client.feedbackRequired': 'Hãy mô tả nội dung bạn cần chỉnh sửa.', 'client.approvedToast': 'Cảm ơn bạn. Xác nhận duyệt đã được gửi.', 'client.changesToast': 'Yêu cầu chỉnh sửa đã được gửi.', 'client.responseError': 'Chưa thể gửi phản hồi. Vui lòng thử lại.',
		'client.latestReport': 'Báo cáo tiến độ mới nhất', 'client.noReportsTitle': 'Báo cáo đầu tiên đang được chuẩn bị.', 'client.noReportsText': 'Cập nhật ngắn gọn từ studio sẽ xuất hiện tại đây.', 'client.reportTitle': 'Cập nhật từ Pozan Market', 'client.olderReports': 'Xem các báo cáo trước', 'client.tracking': 'Theo dõi dự án', 'client.simpleFeedbackTitle': 'Một nơi duy nhất để phản hồi.'
	}
};
