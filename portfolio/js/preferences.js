...
const COPY = {
	en: {
		...
		'admin.clientUpdate': 'Update visible to client', 'admin.clientUpdatePlaceholder': 'Share the latest progress, decision or what you need from the client…', 'admin.clientUpdateHint': 'This message is visible in the client portal.', 'admin.copyPortal': 'Copy client portal', 'admin.portalCopied': 'Private client portal link copied.', 'admin.copyPortalPrompt': 'Copy this private client portal link:',
	...
	vi: {
		...
		'admin.clientUpdate': 'Cập nhật hiển thị cho khách', 'admin.clientUpdatePlaceholder': 'Chia sẻ tiến độ mới nhất, quyết định hoặc điều bạn cần khách cung cấp…', 'admin.clientUpdateHint': 'Nội dung này sẽ xuất hiện trong Client Portal.', 'admin.copyPortal': 'Sao chép portal khách', 'admin.portalCopied': 'Đã sao chép link Client Portal riêng tư.', 'admin.copyPortalPrompt': 'Sao chép link Client Portal riêng tư này:',
